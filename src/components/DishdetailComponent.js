                    ...
                    <ModalBody>
                        <LocalForm onSubmit = {values => this.handleSubmit(values)}>
                            <Row className = "form-group">
                                ...
                                <Col md = {12}>
                                    <Control.select model = '.rating' name = "rating" className = "form-control" type = "select" defaultValue = "1">
                                        <option>1</option>
                                        <option>2</option>
                                        <option>3</option>
                                        <option>4</option>
                            ...
                            <Row className = "form-group">
                                ...
                                <Col md = {12}>
                                    <Control.text model = ".author" name = "author" className = "form-control" placeholder = "Your Name" validators = {{ minLength: minLength(3), maxLength: maxLength(15) }} />
                                    <Errors
                            ...
                            <Row className = "form-group">
                                ...
                                <Col md = {12}>
                                    <Control.textarea model = ".comment" name = "comment" className = "form-control" type = "textarea" rows = "6" />
                                </Col>
                            </Row>
                            <Row className = "form-group">
                                <Col md = {{size: 10}}>
